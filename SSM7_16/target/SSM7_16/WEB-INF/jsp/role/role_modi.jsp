                    ...
                    <div class="input_info_scroll">
                        <ul>
                            ...
                            <c:forEach var="roleModule" items="${map.get('role').moduleList}">
                                <li><input type="checkbox" name="moduleName" value="${roleModule.name}" checked />${roleModule.name}</li>
                            </c:forEach>
                            <c:forEach var="module" items="${map.get('allModul')}">
                                <li><input type="checkbox" name="moduleName" value="${module.name}" />${module.name}</li>
                            </c:forEach>
